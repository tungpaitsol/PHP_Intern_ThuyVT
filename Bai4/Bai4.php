...
$_SESSION['arr'] = $arr;
	...
	{
		$arr1=bubble_sort_asc($arr1,'1');
		table_echo($arr1,$n);
	}
	if(isset($_POST['des_pri']))
	{
		$arr1=bubble_sort_des($arr1,'1');
		table_echo($arr1,$n);
	}
	if(isset($_POST['asc_ord']))
	{
		$arr1=bubble_sort_asc($arr1,'3');
		table_echo($arr1,$n);
	}
	if(isset($_POST['des_ord']))
	{
		$arr1=bubble_sort_des($arr1,'3');
		table_echo($arr1,$n);
	}
	if(isset($_POST['asc_total']))
	{
		$arr1=bubble_sort_asc($arr1,'4');
		table_echo($arr1,$n);
	}
	if(isset($_POST['des_total']))
	{
		$arr1=bubble_sort_des($arr1,'4');
		table_echo($arr1,$n);
	}
	...
	function bubble_sort_asc($mang,$a){
		$sophantu = count($mang);
	...
	function bubble_sort_des($mang,$a){
		$sophantu = count($mang);
		for ($i = 0; $i < ($sophantu - 1); $i++)
		{
		    for ($j = $i + 1; $j < $sophantu; $j++)
