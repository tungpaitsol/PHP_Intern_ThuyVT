...
<body>
    ...
    <form method="post" action="">
        <input type="text" style="width: 30px" name="a" autofocus value="<?php echo isset($_POST['a']) ? $_POST['a'] : '' ?>"/>x<sup>2</sup>
        +
        <input type="text" style="width: 30px" name="b" autofocus value="<?php echo isset($_POST['b']) ? $_POST['b'] : '' ?>"/>x
        + 
        <input type="text" style="width: 30px" name="c" autofocus value="<?php echo isset($_POST['c']) ? $_POST['c'] : '' ?>"/>
        = 0
        <br/><br/>
	...
	if(isset($_POST['gptb2']))
	{
		...
		if($a=='0' && $b=='0' && $c=='0')
			$result="Phương trình đúng với mọi nghiệm.";
